...
def get_args():
  ...
  parser.add_argument(
    '--split_dataset', default='', help="Give the path of dataset file which you want to split.", type=str
  )
  parser.add_argument(
    '--new_train_file_path', default='', help="Give the path where to store the splited train set.", type=str
  )
  parser.add_argument(
    '--new_valid_file_path', default='', help="Give the path where to store the splited valid set.", type=str
  )
